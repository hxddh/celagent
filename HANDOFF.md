...
- ✅ **v0.3.1 资产清单**(Release workflow 上传):celagent 五平台(含 windows-x64.exe); celld-linux-x64 / celld-linux-arm64 / celld-darwin-arm64; install.sh / install.ps1 / worker.tar.gz / SHA256SUMS
